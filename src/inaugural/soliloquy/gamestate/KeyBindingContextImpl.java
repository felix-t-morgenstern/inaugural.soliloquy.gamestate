...
public class KeyBindingContextImpl implements KeyBindingContext {
    ...
    @Override
    public void putAll(ReadableCollection<Pair<Character, KeyBinding>> readableCollection) throws IllegalArgumentException {
    ...
    @Override
    public boolean equals(ReadableCollection<KeyBinding> readableCollection) throws IllegalArgumentException {
        return false;
    }
