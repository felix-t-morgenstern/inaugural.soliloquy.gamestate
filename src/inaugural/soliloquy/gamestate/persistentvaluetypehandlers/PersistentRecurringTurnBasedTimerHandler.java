...
public class PersistentRecurringTurnBasedTimerHandler
        extends PersistentTypeHandler<RecurringTurnBasedTimer> {
    ...
    public PersistentRecurringTurnBasedTimerHandler(TurnBasedTimerFactory turnBasedTimerFactory,
                                                    @SuppressWarnings("rawtypes")
    ...
    @Override
    public RecurringTurnBasedTimer getArchetype() {
        return ARCHETYPE;
    }
    ...
    public RecurringTurnBasedTimer read(String data) throws IllegalArgumentException {
        if (data == null) {
            throw new IllegalArgumentException(
                    "PersistentRecurringTurnBasedTimerHandler.read: data cannot be null");
        }
        if (data.equals("")) {
            throw new IllegalArgumentException(
                    "PersistentRecurringTurnBasedTimerHandler.read: data cannot be empty");
        }
